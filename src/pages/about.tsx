...
export default function About() {
  return (
    <>
      <Head>
        <title>Diego Almeida | About Page</title>
        <meta name="description" content="Diego Almeida about page" />
      </Head>
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16">
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light/75">
              <div className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light/75" />
              <Image src={profilePic} alt="Diego Almeida" className="w-full h-auto rounded-2xl" 
                priority 
